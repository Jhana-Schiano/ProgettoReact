...
const DettaglioPage = () => {
  ...
  const {
    ricettaSelezionata: selectedRecipe,
    caricamentoDettaglio: detailLoading,
    erroreDettaglio: detailError,
  } = useSelector((state) => state.ricette);
          ...
          <div className={styles.infoContainer}>
            ...
            <div className={styles.tags}>
              {selectedRecipe.vegetarian && (
                <span className={styles.tag}>🌱 Vegetariano</span>
              )}
            ...
            <div className={styles.info}>
              ...
              {selectedRecipe.pricePerServing && (
                <span>
                  💰 ${(selectedRecipe.pricePerServing / 100).toFixed(2)} per
                  porzione
                </span>
              )}
            </div>
